            ...
            <div class="rightDiv">
             ...
             <div class="leftDiv" dir="rtl">
                <form class="loginForm" action="" method="post">
                    ...
                    <input class="input" name="name" type="text" placeholder="الاسم" required>
                    <input class="input" name="pass" type="password" placeholder="كلمة المرور" required>
                    <input class="input" name="re_pass" type="password" placeholder="تأكيد كلمة المرور" required>
                    <input class="input" name="phone" type="text" placeholder="رقم التليفون" required>
